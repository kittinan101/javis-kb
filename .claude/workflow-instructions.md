...
4. **Update Notion status page** *(เฉพาะช่วง implement POC — หยุดเมื่อ implementation จบ)* — หน้า "📌 Javis — Project Status" (page id `3a27995ac8318167afd6c0db11482857` ใต้หน้า Javis AI) ผ่าน Notion MCP: อัพเดต % สถานะ, ติ๊ก/เพิ่มรายการงานที่ยังไม่เรียบร้อย, แก้วันที่ในหัวเรื่อง — ทำทุกครั้งที่สถานะ milestone/task สำคัญเปลี่ยน — เนื้อหาเป็นสรุปสถานะเท่านั้น ห้ามย้าย design docs กลับไป Notion (repo ยังเป็น source of truth)
   **บริบทโปรเจกต์ (user แจ้ง 2026-07-19):** งานที่ implement ทั้งหมดตอนนี้คือ **POC เพื่อนำเสนอ** — ถ้าผ่านการนำเสนอจะ**ย้ายไป environment กลางสำหรับทีม**อีกที (infra ปัจจุบัน: NAS ส่วนตัว = ชั่วคราว) → การตัดสินใจเชิง infra ให้คิดแบบ "ของย้ายได้" ไม่ lock-in กับ NAS
