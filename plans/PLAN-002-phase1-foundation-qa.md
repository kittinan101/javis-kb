...
#### T1.2 Import เอกสารชุดแรกจาก Notion 🔄 (2026-07-18: import แล้ว 6 — vision, impl spec, taskbot design, engineering standards, QA guidelines, onboarding; KB รวม 15 ไฟล์ผ่าน validation)
- [x] ลิสต์หน้า Notion ที่จะ import — เจอครบ: Javis AI vision ✅, Implementation Spec ✅, System Design Phase 1 ✅ (→ domain `taskbot`), Wiki ทีม (Engineering Standards ✅ / QA Guidelines ✅ / Onboarding ✅ — ยังเป็นโครง รอทีมเติมเนื้อ; How-to Guides + Release Notes เป็น index ว่าง ยังไม่ import)
